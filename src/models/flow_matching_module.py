...
class ode_wrapper(torch.nn.Module):
    ...
    Args:
        ...
        diff_config (Mapping, optional): Config for diffusion noise scheduling.
        Only necessary when using loss_type="diffusion". Defaults to {"max_sr": 0.999, "min_sr": 0.02}.
    """
...
class CNF(nn.Module):
    """Continuous Normalizing Flow with EPiC Generator.
